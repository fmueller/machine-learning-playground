...
class MatchParserTest {
  ...
  void parseOneMatch() {
    ...
    assertThat(matches).containsOnly(new Match(new LocalDate(2008, 1, 30), "Cameroon", "Sudan", 3, 0, 1.10, 7.73, 17.11))
  }
  ...
  void parseManyMatches() {
    ...
    assertThat(matches).containsOnly(new Match(new LocalDate(2011, 9, 6), "Iceland", "Cyprus", 1, 0, 2.06, 3.34, 3.60),
        new Match(new LocalDate(2011, 9, 6), "Italy", "Slovenia", 1, 0, 1.4, 4.37, 8.59),
        new Match(new LocalDate(2011, 9, 6), "Austria", "Turkey", 0, 0, 2.9, 3.33, 2.41))
  }
}
